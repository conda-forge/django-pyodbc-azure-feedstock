About django-pyodbc-azure-feedstock
===================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/django-pyodbc-azure-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/michiya/django-pyodbc-azure
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3846&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/django-pyodbc-azure-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `django-pyodbc-azure` can be installed with `conda`:
...
```
mamba install django-pyodbc-azure
```

It is possible to list all of the versions of `django-pyodbc-azure` available on your platform with `conda`:
...
```
mamba search django-pyodbc-azure --channel conda-forge
```
...
mamba repoquery search django-pyodbc-azure --channel conda-forge

# List packages depending on `django-pyodbc-azure`:
mamba repoquery whoneeds django-pyodbc-azure --channel conda-forge

# List dependencies of `django-pyodbc-azure`:
mamba repoquery depends django-pyodbc-azure --channel conda-forge
```
